---@class keystone.breadcrumbs.Core
local M = {}

-- ---------------------------------------------------------------------------
-- Breadcrumbs implementation: winbar rendering, LSP document symbol tracking
-- and the autocommands that keep them in sync.
--
-- Required lazily by `keystone.breadcrumbs` on first enable, so a user who
-- never turns breadcrumbs on never loads any of this.
-- ---------------------------------------------------------------------------
