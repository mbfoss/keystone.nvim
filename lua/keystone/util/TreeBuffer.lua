...
---@alias keystone.util.TreeBuffer.FormatterFn fun(id:any, data:any, expanded:boolean, prefix_width:integer):string[][], string[][], string?
...
---@field private _indent_cache table<integer, keystone.util.TreeBuffer.Indent>
...
function TreeBuffer:create_buffer(on_deleted)
    ...
    vim.api.nvim_create_autocmd("BufReadCmd", {
        buffer = self._bufnr,
        callback = function()
            vim.bo[self._bufnr].filetype = self._filetype or "keystone-tree"
            self:_full_render()
        end,
    })
...
---@private
---@param depth integer
---@return keystone.util.TreeBuffer.Indent
