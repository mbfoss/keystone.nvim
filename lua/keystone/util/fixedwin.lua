...
---@type table<string, keystone.util.fixedwin.AxisSpec>
local _AXES = {
    height = {
...
-- `vim.wo[win].opt = val` also sets the global default new windows inherit
---@param win integer
---@param opt string
---@param val any
local function win_setlocal(win, opt, val)
...
---@class keystone.util.fixedwin.Opts
...
---@param opts keystone.util.fixedwin.Opts
...
function M.create_fixed_win(buf, opts)
    ...
    local active = spec ---@type keystone.util.fixedwin.AxisSpec?

    ---@param s keystone.util.fixedwin.AxisSpec
    ---@param r number
    ---@return integer
