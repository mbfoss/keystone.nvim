...
---@class keystone.util.fileextmarks.MarkInfo
---@field id number
---@field file string
...
---@class keystone.util.fileextmarks.MarkData
---@field id number
---@field ns number
---@field lnum number        -- 1-based
---@field col number        -- 0-based
...
---@alias keystone.util.fileextmarks.ById table<number, keystone.util.fileextmarks.MarkData>
---@alias keystone.util.fileextmarks.ByFile table<string, keystone.util.fileextmarks.ById>

---@class keystone.util.fileextmarks.GroupData
---@field ns number
---@field byfile keystone.util.fileextmarks.ByFile
---@field id_to_file table<number, string>

---@type table<string, keystone.util.fileextmarks.GroupData>
...
---@param bufnr integer
---@param mark keystone.util.fileextmarks.MarkData
...
---@param group_data keystone.util.fileextmarks.GroupData
...
local function _set_file_extmark(id, file, lnum, col, group_data, opts, user_data)
    ...
    ---@type keystone.util.fileextmarks.MarkData
    local mark = {
        id = id,
        ns = group_data.ns,
        lnum = lnum,
...
---@param id number
---@param group_data keystone.util.fileextmarks.GroupData
---@return keystone.util.fileextmarks.MarkInfo?
...
---@class keystone.util.fileextmarks.GroupFunctions
...
---@field get_extmark_by_id fun(id:number): keystone.util.fileextmarks.MarkInfo?
---@field get_extmark_by_location fun(file:string, line:number, live:boolean): keystone.util.fileextmarks.MarkInfo?
---@field get_extmarks fun(live:boolean): keystone.util.fileextmarks.MarkInfo[]
---@field get_file_extmarks fun(file:string, live:boolean): keystone.util.fileextmarks.MarkInfo[]
---@field refresh fun()

---@param group string  unique name; used as the extmark namespace and (on first call) the augroup name
---@return keystone.util.fileextmarks.GroupFunctions
function M.define_group(group)
    ...
    ---@type keystone.util.fileextmarks.GroupData
    local group_data = {
