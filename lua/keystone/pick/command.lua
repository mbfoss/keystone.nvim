...
local pickers = {
    ...
    config_files         = function() require("keystone.pick.pickers.files").open({ cwd = vim.fn.stdpath("config"), prompt = "Config files" }) end,
    ...
    document_diagnostics = function() require("keystone.pick.pickers.diagnosics").document_diagnostics() end,
    git_diff             = function() require("keystone.pick.pickers.gitdiff").open() end,
