...
---@alias keystone.neotoolkit.usercmd.subcommand_fn fun(cmd:string,rest:string[],arg_lead:string):string[]

---@alias keystone.neotoolkit.usercmd.run_fn
---| fun(cmd:string,args:string[],opts:vim.api.keyset.create_user_command.command_args)


---@param subcommand_fn keystone.neotoolkit.usercmd.subcommand_fn
...
---@param cmd string
---@param run_fn keystone.neotoolkit.usercmd.run_fn
...
local function _dispatch(cmd, run_fn, opts)
    ...
    if not ok then
        vim.notify(
            "[keystone.neotoolkit.nvim] " .. cmd .. " command error\n" .. tostring(err),
...
---@param cmd string
---@param run_fn keystone.neotoolkit.usercmd.run_fn
---@param opts {desc:string?,subcommand_fn:keystone.neotoolkit.usercmd.subcommand_fn?}?
