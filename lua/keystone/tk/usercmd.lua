...
---@alias keystone.tk.usercmd.subcommand_fn fun(cmd:string,rest:string[],arg_lead:string):string[]

---@alias keystone.tk.usercmd.run_fn
---| fun(cmd:string,args:string[],opts:vim.api.keyset.create_user_command.command_args)


---@param subcommand_fn keystone.tk.usercmd.subcommand_fn
...
---@param cmd string
---@param run_fn keystone.tk.usercmd.run_fn
---@param opts {desc:string?,subcommand_fn:keystone.tk.usercmd.subcommand_fn?,count:boolean,range:boolean}?
