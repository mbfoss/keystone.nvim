...
---@class keystone.tk.TermHandle
---@field bufnr number
---@field pid   integer
---@field stop  fun()  stop the spawned command

---@class keystone.tk.SpawnOpts
...
---@param opts  keystone.tk.SpawnOpts
...
---@return keystone.tk.TermHandle?,string?
function M.spawn(cmd, opts, bufnr)
    ...
    return { ---@type keystone.tk.TermHandle
        bufnr = bufnr,
        pid   = job_pid or 0,
        stop  = function()
